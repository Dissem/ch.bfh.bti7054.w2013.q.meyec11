...
<ul id="loginBlock" class="nav navbar-nav navbar-right"
<?php $this->display(true)?>>
	<li><a href="#" onclick="return go('signup');"><?php echo _("Sign Up")?></a></li>
	<li class="dropdown"><a class="dropdown-toggle" href="#"
		data-toggle="dropdown"><?php echo _("Sign In")?> <strong class="caret"></strong></a>
	<div class="dropdown-menu" style="padding: 15px;"><!-- Login form here -->
	<form id="loginForm" action="ajax.php" method="post"
		accept-charset="UTF-8"><input id="user_username" name="username"
		type="text" class="form-control"
		placeholder="<?php echo _("e-mail")?>" /> <input id="user_password"
	...
	<label for="user_remember_me"> <?php echo _("Remember me")?></label> <input
		class="btn btn-primary" type="submit"
		value="<?php echo _("Sign In")?>" onclick="return login();"
		style="width: 100%" /></form>
	</div>
	</li>
</ul>
<ul id="logoutBlock" class="nav navbar-nav navbar-right"
